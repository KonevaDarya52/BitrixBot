...
| ------------------------------ | -------------------------------- | ----------------------------------------- |
| **API Сервер**                 | `http://localhost:3000`          | Основной веб-интерфейс (Карта)            |
| **Bitrix24 Чат-бот**           | `http://localhost:8000/swagger/` | Список возможных api ссылок и их описание |
| **Административный интерфейс** | `http://localhost:8000/admin/`   | Админка Django (просмотр базы)            |
